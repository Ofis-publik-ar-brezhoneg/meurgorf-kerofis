    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usage', models.CharField(choices=[('VER', 'Very Usual'), ('USU', 'Usual'), ('UNC', 'uncommon')], db_column='mp_implij', default='USU', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phonetic_form', models.TextField(blank=True, db_column='md_distagadur', null=True)),
                ('url', models.CharField(blank=True, db_column='md_distagadur_enrolladenn', max_length=30, null=True)),
